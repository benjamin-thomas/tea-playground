module WithoutStoringPosition.MetaMessage.Main exposing (main)

import Browser
import Html as H exposing (Html)
import Html.Attributes as HA
import Html.Events as HE
import WithoutStoringPosition.MetaMessage.Counter as Counter exposing (ExternalMsg(..))
